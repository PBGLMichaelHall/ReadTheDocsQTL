...
# QTLParser_1_MH <- function (vcf, HighBulk, LowBulk, filename)
This is the function I described from paragraph above. 

# getG_MH 
This function is interchangeable with getG and is exact verbatim no chages has been made, however I was having issues getting the function to load when I downloaded his package. For more information refer to Mansfield's Vignette. Mostly it calculates G Statistic taking High Alt, High Ref, Low Alt, and Low Ref as inputs. It is called in runGprimeAnalysis function.

# tricubeStat_MH
This function is interchangeable with tricubeStat and is exact verbatim no changes have been made, however I was having issues getting the function to load when I downloaded it. It is called in runGprimeAnalysis function to calculate delta SNP.

# runGprimeAnalysis_MH
In this function I use getPvals_MH which is a modification of getPvals. The modification I made occurs to remove any NA values generated by accident or by some glitch. When I attempted to runGprimeAnalysis using getPvalus I generated an error and this modification worked to patch it. I do not say whether it is right or wrong I am not concerned about ethics only functionality, form, and robust analysis. 
...
I have modified the original runQTLseqAnalysis because again NA's were generated.
Please see line 298 where I added the code line...
SNPset <- SNPset %>% drop_na()
Other than that everything is identical.

# plotGprimeDist_MH
This function is verbatim as plotGprimeDist no changes have been made.
...
# plotQTLStats_MH 
This is the same thing as "plotQTLStats_MH2"
